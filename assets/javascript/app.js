var countryCode = ["all", "au", "br", "ca", "fr", "de", "mx", "nz", "it", "za", "es", "pt", "us", "uk"];
var countries = ["All", "Australia", "Brazil", "Canada", "France", "Germany", "Mexico", "New Zealand", "Italy", "South Africa", "Spain", "Portugal", "U.S.A.", "United Kingdom"];
...
function renderCountires() {
    ...
    for (var i = 0; i < countryCode.length; i++) {
      var newCountry = $("<option>");
      newCountry.text(countries[i]);
      newCountry.attr("value", countryCode[i]);
